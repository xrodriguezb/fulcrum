...
export interface components {
    schemas: {
        ...
        Problem: {
            ...
            status: number;
            /** @enum {string} */
            code: "VALIDATION_FAILED" | "ORDER_NOT_FOUND" | "ORDER_INVALID_STATE" | "INVENTORY_INSUFFICIENT" | "IDEMPOTENCY_KEY_REQUIRED" | "IDEMPOTENCY_KEY_REUSE" | "IDEMPOTENCY_REQUEST_IN_PROGRESS" | "METHOD_NOT_ALLOWED" | "REQUEST_TOO_LARGE" | "UNSUPPORTED_MEDIA_TYPE" | "SERVICE_UNAVAILABLE" | "INTERNAL_ERROR";
            detail?: string;
            instance?: string;
            trace_id?: string;
        };
